...
public class StaticInteractionDetails implements InteractionDetailsDAO {
    ...
    private final Logger logger = LoggerFactory.getLogger(StaticInteractionDetails.class);
    ...
    public boolean create(List<InteractionDetails> interactionDetails) throws SQLException {
        ...
        final String TABLE = "INTERACTION_DETAILS";
        final String ALL_COLUMNS = "INTERACTION_ID, INTERACTION_AC";

        try {
            String query = "INSERT INTO " + TABLE + " (" + ALL_COLUMNS + ") VALUES(?, ?)";
    ...
    private InteractionDetails buildInteractionDetails(ResultSet rs) throws SQLException {
